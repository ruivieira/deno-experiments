...
function decodeEntity(name) {
    return Html5Entities.decode(name);
}
function typeOf(obj) {
...
function Remarkable1(preset, options) {
...
Remarkable1.prototype.set = function(options) {
    assign(this.options, options);
};
Remarkable1.prototype.configure = function(presets) {
    var self = this;
    if (!presets) {
...
Remarkable1.prototype.use = function(plugin, options) {
    plugin(this, options);
    return this;
};
Remarkable1.prototype.parse = function(str, env) {
    var state = new StateCore(this, str, env);
    this.core.process(state);
    return state.tokens;
};
Remarkable1.prototype.render = function(str, env) {
    env = env || {
    };
    return this.renderer.render(this.parse(str, env), this.options, env);
};
Remarkable1.prototype.parseInline = function(str, env) {
    var state = new StateCore(this, str, env);
    state.inlineMode = true;
    this.core.process(state);
    return state.tokens;
};
Remarkable1.prototype.renderInline = function(str, env) {
    env = env || {
    };
    return this.renderer.render(this.parseInline(str, env), this.options, env);
};
export { Remarkable1 as Remarkable, utils1 as utils };
