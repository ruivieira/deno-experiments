import {Task} from "./core.ts"
import {qs} from "https://deno.land/x/deno_qs/mod.ts";

export interface TodoistTask extends Task {
    id: number;
    project_id: number;
}
...
export class Todoist {
    ...
    getAllTasks(): Promise<Array<TodoistTask>> {
    ...
    getTasks(options: TaskOptions): Promise<Array<TodoistTask>> {
